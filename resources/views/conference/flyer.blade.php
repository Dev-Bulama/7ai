...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-webshare{background:#4f46e5;color:#fff}
...
<div class="container">
    ...
    <div class="result-section" id="result-section">
        ...
        <div class="share-grid" id="share-btns">
            <button class="btn-share btn-download btn-full" id="btn-download">&#11015; Download PNG</button>
            <button class="btn-share btn-webshare btn-full" id="btn-webshare" style="display:none">&#128228; Share to Apps</button>
            <a class="btn-share btn-wa" id="btn-wa" href="#" target="_blank" rel="noopener">
            ...
            <button class="btn-share btn-copy" id="btn-copy">&#128279; Copy Link</button>
        </div>
    </div>
</div>
...
(function(){
    ...
    document.getElementById('btn-gen').addEventListener('click', function(){
        ...
        html2canvas(target, {
            ...
            var msg = encodeURIComponent(name + ' is attending ' + '{{ addslashes($settings->event_name ?? "Abuja AI Conference") }}' + '! ' + hashtag + ' ' + PAGE_URL);
            document.getElementById('btn-wa').href = 'https://wa.me/?text=' + msg;
    ...
    document.getElementById('btn-webshare').addEventListener('click', function(){
        ...
        }).catch(function(err){ if(err.name !== 'AbortError') showToast('Share failed.'); });
    });
