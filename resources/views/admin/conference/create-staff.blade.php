<x-admin-layout title="Add Staff Account">
<div style="padding:32px;max-width:600px;">
  ...
  <div style="margin-bottom:24px;">
    ...
    <h1 style="font-size:20px;font-weight:700;color:#1a202c;margin:0;">Add Staff Account</h1>
  </div>
  ...
  <form method="POST" action="{{ route('admin.conference.store-staff') }}"
    ...
    <div style="display:grid;gap:20px;">
      ...
      <div>
        <label style="display:block;font-size:12px;font-weight:600;color:#4a5568;margin-bottom:6px;">Email Address</label>
      ...
      <div>
        ...
        <select name="role" required
          ...
          <option value="front-desk-staff" @selected(old('role')==='front-desk-staff')>Front Desk Staff</option>
          <option value="lunch-staff" @selected(old('role')==='lunch-staff')>Lunch Staff</option>
        </select>
      </div>
      <div>
        <label style="display:block;font-size:12px;font-weight:600;color:#4a5568;margin-bottom:6px;">Password</label>
